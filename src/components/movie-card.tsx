  ...
  const cardContent = (
    <Card className="overflow-hidden bg-secondary border-0 group rounded-lg flex flex-col h-full cursor-pointer">
       <CardContent className="p-0 flex flex-col h-full">
        ...
        <div className="p-2 flex-grow flex flex-col justify-center h-16 overflow-hidden">
          {movie.cardInfoText ? (
             <p className="font-bold text-foreground text-base leading-tight [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical] overflow-hidden">
              {movie.cardInfoText}
            </p>
          ) : (
            <>
